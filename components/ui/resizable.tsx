...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.Separator
      ...
      className={cn(
        "relative flex w-px items-center justify-center bg-border transition-colors hover:bg-accent/50 data-[resize-handle-active]:bg-accent",
    ...
    >
      {withHandle && (
        <div
          className="z-10 flex h-8 w-1 shrink-0 rounded-full bg-foreground/25 group-data-[resize-handle-active]/handle:bg-accent"
          aria-hidden
        />
      )}
    </ResizablePrimitive.Separator>
