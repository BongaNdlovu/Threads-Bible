...
function processDetail(id: string, d: ThreadDetail) {
  ...
  if (d.terms && d.terms.length > 0) {
    d.terms.forEach((t, i) => {
      ...
      // @ts-expect-error optional exposition in data
