...
export const MESSIANIC_PROPHECIES: MessianicProphecy[] = [
  ...
  {
    id: 'mes-gen-22-8',
    prophecyRef: 'Genesis 22:2-14',
    otVerseId: 'gen-22-8',
    fulfillmentRefs: ['Hebrews 11:17-19', 'John 1:29', 'John 3:16', 'Romans 8:32', '1 Peter 1:19-20'],
    title: 'The Only Begotten Son Offered on Moriah: The Lamb Provided',
    category: 'Birth & Incarnation',
    ...
    solaScripturaNote: 'Take now thy son, thine only son Isaac, whom thou lovest, and offer him upon Mount Moriah; God will provide himself a lamb: fulfilled when the Father spared not His own Son but delivered Him up for us all at Calvary.',
  },
  {
    id: 'mes-hos-11-1',
  ...
  },
  {
    ...
    otVerseId: 'zec-12-10',
    fulfillmentRefs: ['John 19:34-37', 'Revelation 1:7', 'Matthew 24:30'],
  ...
  },
  {
    ...
    otVerseId: 'psa-110-1',
    fulfillmentRefs: ['Matthew 22:42-45', 'Acts 2:34-36', 'Hebrews 1:13', 'Hebrews 5:6', 'Hebrews 7:17', 'Hebrews 7:21', 'Hebrews 8:1-2'],
    title: 'Enthroned at the Right Hand: Melchizedekian Priest Forever',
    category: 'Priesthood & Heavenly Reign',
  ...
  },
  {
    ...
    otVerseId: 'mal-4-2',
    fulfillmentRefs: ['Luke 1:78-79', 'Matthew 17:2', '2 Peter 1:19', 'Revelation 22:16', '2 Peter 3:10-13', 'Revelation 20:14-15'],
