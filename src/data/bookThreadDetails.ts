...
export const bookThreadDetails: Record<string, ThreadDetail> = {
  ...
  'exo-12-46': {
    ...
    cumulativePrinciples: [
      ...
      'Connection 1 (2 Verses in Common — Exodus 12:46 & John 19:36): Expanding the foundational principle: John watches the soldiers break the thieves\' legs and stop at Jesus. What these two verses share: “a bone of him shall not be broken” is both Mosaic statute and Golgotha fact. How they connect: ἵνα ἡ γραφὴ πληρωθῇ — Scripture is the cause, not a later caption. Why they connect: the Father kept the Lamb whole so the Exodus shelter still names the cross.',
      'Connection 2 (3 Verses in Common — Exodus 12:46, John 19:36, & Numbers 9:12): Expanding the thread across all 3 witnesses: Numbers restates the same bone-law for later Passovers, proving it is standing Torah. What these 3 verses share: the lamb remains whole whether in Egypt, in the wilderness, or on the cross. How the redemptive arc unfolds: statute, restated statute, then historical fulfillment when crurifragium is withheld. Canonical climax: Jesus is the true Passover whose unbroken body confirms that His offering is complete and unmarred.',
    ],
