...
export const threadChains: ThreadChain[] = [
  {
    ...
    steps: [
      ...
      { ref: 'Genesis 22:18', verseId: 'gen-22-18', testament: 'OT', title: 'In your seed all nations bless themselves', connection: 'Same-OT: after Abraham offered Isaac, the promise narrowed to one heir.' },
      { ref: 'Genesis 49:10', verseId: 'gen-49-10', testament: 'OT', title: 'Shiloh / scepter of Judah', connection: 'Same-OT: the promised line becomes a royal line, and Judah\'s scepter lasts until Shiloh.' },
      ...
      { ref: 'Galatians 3:16', testament: 'NT', title: 'The Seed is Christ', connection: 'NT names the one "seed" promised to Abraham. That Seed is Christ.' },
      { ref: 'Romans 16:20', testament: 'NT', title: 'God crushes Satan under your feet', connection: 'NT applies the promise of the crushed head to the church that is in Christ.' },
    ],
  },
  {
    ...
    steps: [
      { ref: 'Genesis 12:1-3', verseId: 'gen-12-1', testament: 'OT', title: 'Call of Abram — blessing to all families', connection: 'This is the first time God promises to bless all nations.' },
      { ref: 'Genesis 13:15-16', verseId: 'gen-13-15', testament: 'OT', title: 'Land forever, dust-like seed', connection: 'Same-OT: God adds land and more descendants to the promise.' },
      { ref: 'Genesis 15:5-6', verseId: 'gen-15-5', testament: 'OT', title: 'Stars counted; believed → righteousness', connection: 'Same-OT: God counts Abraham\'s faith as righteousness.' },
      { ref: 'Genesis 17:5-8', verseId: 'gen-17-5', testament: 'OT', title: 'Abraham, many nations, everlasting covenant', connection: 'Same-OT: God changes Abram\'s name and seals the covenant with circumcision.' },
      { ref: 'Genesis 18:18', verseId: 'gen-18-18', testament: 'OT', title: 'All nations blessed in him', connection: 'Same-OT: God repeats His purpose for all nations, not only for Israel.' },
      { ref: 'Genesis 26:3-4', verseId: 'gen-26-4', testament: 'OT', title: 'Promise confirmed to Isaac', connection: 'Same-OT: the promise passes to Isaac unchanged.' },
      { ref: 'Genesis 28:14', verseId: 'gen-28-14', testament: 'OT', title: 'All families of the earth blessed in Jacob', connection: 'Same-OT: God repeats the same promise to Jacob.' },
      { ref: 'Exodus 19:5-6', testament: 'OT', title: 'Kingdom of priests', connection: 'Same-OT: God placed Israel among the nations as a kingdom of priests.' },
      { ref: 'Psalm 67:1-4', testament: 'OT', title: 'Nations praise God', connection: 'Same-OT: the goal of the blessing is worship.' },
      { ref: 'Galatians 3:8-9, 29', testament: 'NT', title: 'Gospel preached to Abraham; heirs by faith', connection: 'NT: Christ brings the blessing to everyone who believes.' },
      { ref: 'Acts 3:25-26', testament: 'NT', title: 'You are children of the covenant', connection: 'NT: the apostles preached from this Abrahamic thread.' },
    ],
  },
  {
    ...
    steps: [
      { ref: 'Genesis 14:18-20', verseId: 'gen-14-18', testament: 'OT', title: 'Melchizedek blesses Abram with bread and wine', connection: 'Earliest priest-king outside Levi. Abram pays him a tithe.' },
      { ref: 'Psalm 110:1-4', testament: 'OT', title: 'You are a priest forever after the order of Melchizedek', connection: 'Same-OT: the LORD\'s anointed king is made a priest forever. He is not from Aaron\'s family.' },
      { ref: 'Hebrews 5:6-10', testament: 'NT', title: 'Christ called as High Priest', connection: 'NT applies Ps 110 to Jesus\' priesthood.' },
      { ref: 'Hebrews 7:1-28', testament: 'NT', title: 'Better priesthood, better covenant', connection: 'NT shows Melchizedek as greater, as never dying, and as one who makes people perfect.' },
    ],
  },
  {
    id: 'provided-lamb',
    ...
    origin: 'Genesis 3:21',
    steps: [
      { ref: 'Genesis 3:21', verseId: 'gen-3-21', testament: 'OT', title: 'Coats of skins — God clothes them by blood', connection: 'Earliest covering requires death of an animal.' },
      { ref: 'Genesis 4:4', verseId: 'gen-4-4', testament: 'OT', title: 'Abel\'s firstlings accepted', connection: 'Same-OT: the sacrifice God accepts is the firstborn animal given by blood.' },
      { ref: 'Genesis 8:20', verseId: 'gen-8-20', testament: 'OT', title: 'Noah\'s burnt offering — a sweet savour to the LORD', connection: 'Same-OT: God turns judgment into mercy when his people bring a sacrifice.' },
      { ref: 'Genesis 22:2-14', verseId: 'gen-22-2', testament: 'OT', title: 'God will provide Himself the lamb', connection: 'Same-OT: a substitute animal died in place of the only son on Moriah.' },
      { ref: 'Exodus 12:3-13', testament: 'OT', title: 'Passover lamb', connection: 'Same-OT: blood on doorposts averts death.' },
      { ref: 'Isaiah 53:4-12', testament: 'OT', title: 'The Servant as a sacrificial lamb', connection: 'Same-OT: the Servant carries the sins of others. The LORD lays their sin on him.' },
      { ref: 'John 1:29', testament: 'NT', title: 'Behold the Lamb of God', connection: 'NT names Jesus as the Lamb God provides, the one who takes away sin.' },
      { ref: 'Romans 8:32', testament: 'NT', title: 'He did not spare His own Son', connection: 'NT: the Father gives his own Son, as God provided the ram for Isaac.' },
      { ref: '1 Peter 1:19-20', testament: 'NT', title: 'Lamb without blemish, foreknown', connection: 'NT: God chose this unblemished sacrifice before the world began.' },
    ],
  },
  {
    ...
    steps: [
      ...
      { ref: 'Genesis 38:26-30', verseId: 'gen-38-26', testament: 'OT', title: 'Tamar and Perez — line preserved', connection: 'Same-OT: the promised King\'s family line runs on through this scandal and through grace.' },
      { ref: 'Genesis 49:8-12', verseId: 'gen-49-8', testament: 'OT', title: 'Lion of Judah; scepter to Shiloh', connection: 'Same-OT: the tribal blessing spoken over Judah becomes a prophecy about the promised King.' },
      { ref: 'Ruth 4:18-22', testament: 'OT', title: 'David from Judah\'s line', connection: 'Same-OT: the family line runs from Judah to King David.' },
      { ref: '2 Samuel 7:12-16', testament: 'OT', title: 'Throne established forever', connection: 'Same-OT: eternal dynasty promised to David.' },
      { ref: 'Psalm 89:3-4, 20-37', testament: 'OT', title: 'Covenant with David\'s seed', connection: 'Same-OT: God swore His steadfast love to the anointed king.' },
      ...
      { ref: 'Matthew 1:1-2, 16', testament: 'NT', title: 'Jesus Christ, son of David, son of Abraham', connection: 'NT genealogy runs Abraham, then Judah, then David, then Jesus.' },
      { ref: 'Luke 1:32-33', testament: 'NT', title: 'Throne of his father David', connection: 'NT: the angel\'s message to Mary gives the throne of David to Jesus.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { ref: 'Genesis 5:1-3', verseId: 'gen-5-1', testament: 'OT', title: 'Adam\'s line in God\'s likeness', connection: 'Same-OT: the image was passed on after the fall. It was damaged, but it was not erased.' },
      ...
      { ref: 'Psalm 8:4-8', testament: 'OT', title: 'Man crowned with glory and honor', connection: 'Same-OT: the psalm praises man\'s dominion. Then it asks, "what is man?"' },
      { ref: 'Psalm 110:1', testament: 'OT', title: 'Sit at my right hand', connection: 'Same-OT: the LORD enthrones him at his own right hand.' },
      ...
      { ref: 'Colossians 3:10', testament: 'NT', title: 'Renewed in the image', connection: 'NT: believers are made new in the Messiah.' },
    ],
  },
  {
    id: 'light-word',
  ...
  },
  {
    ...
    steps: [
      { ref: 'Genesis 2:2-3', verseId: 'gen-2-2', testament: 'OT', title: 'God rested and sanctified the seventh day', connection: 'Here is the first rest: God stopped His work and blessed the day.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { ref: 'Exodus 25:17-22; 26:31-33', testament: 'OT', title: 'Cherubim on the mercy seat and veil', connection: 'Same-OT: the holy place was limited. The veil kept God\'s presence hidden.' },
      ...
      { ref: 'Isaiah 35:8-10', testament: 'OT', title: 'Highway of holiness; redeemed walk it', connection: 'Same-OT: the ransomed walk into God\'s presence in the last days.' },
      ...
      { ref: 'Hebrews 9:8; 10:19-20', testament: 'NT', title: 'New and living way through the veil', connection: 'NT: the veil was His flesh. It was torn, and by His blood we come to God.' },
      { ref: 'John 14:6', testament: 'NT', title: 'I am the way', connection: 'NT: the barred way is a Person.' },
      { ref: 'Revelation 22:2, 14', testament: 'NT', title: 'Tree of life in the city; right to the tree', connection: 'NT: Eden\'s access is given back to those washed in the blood.' },
    ],
  },
  {
    id: 'one-flesh-bride',
    ...
    steps: [
      { ref: 'Genesis 2:22-24', verseId: 'gen-2-24', testament: 'OT', title: 'Woman from the man; one flesh', connection: 'The first marriage law, and a real earlier event that points forward to a later one.' },
      ...
      { ref: 'Isaiah 54:5; 62:4-5', testament: 'OT', title: 'Your Maker is your Husband', connection: 'Same-OT: the LORD is the Husband of Israel.' },
      ...
      { ref: 'Ezekiel 16:8-14', testament: 'OT', title: 'I entered into covenant with you', connection: 'Same-OT: marriage is a covenant, God\'s binding promise.' },
      { ref: 'Matthew 19:4-6', testament: 'NT', title: 'What God has joined', connection: 'NT: Jesus grounds marriage in creation again.' },
      { ref: 'Ephesians 5:23-32', testament: 'NT', title: 'Christ and the church', connection: 'NT: the great mystery of one flesh.' },
      { ref: 'Revelation 19:7-9; 21:2, 9', testament: 'NT', title: 'Marriage of the Lamb; bride prepared', connection: 'NT: the wedding of the Messiah and his people at the end of the story.' },
    ],
  },
  {
    id: 'covenant-grace',
    ...
    origin: 'Genesis 6:8',
    steps: [
      { ref: 'Genesis 6:8', verseId: 'gen-6-8', testament: 'OT', title: 'Noah found grace', connection: 'This is the first time the Bible says God showed grace, and it comes before the flood.' },
      { ref: 'Genesis 15:6', verseId: 'gen-15-6', testament: 'OT', title: 'Believed → counted righteousness', connection: 'Same-OT: God declared a guilty man to be in the right before circumcision and before the law.' },
      { ref: 'Genesis 15:18', verseId: 'gen-15-18', testament: 'OT', title: 'Covenant made with Abram', connection: 'Same-OT: God bound Himself alone by this promise, and Abram slept through it.' },
      ...
      { ref: 'Exodus 19:5-6', testament: 'OT', title: 'Covenant at Sinai after grace from Egypt', connection: 'Same-OT: God gave the law to a people He had already rescued from Egypt.' },
      { ref: 'Psalm 32:1-5; 51', testament: 'OT', title: 'Blessed whose transgression is forgiven', connection: 'Same-OT: David confesses that God does not count his sin against him.' },
      { ref: 'Jeremiah 31:31-34', testament: 'OT', title: 'New covenant; law written on hearts', connection: 'Same-OT: God promises to put His law inside them and to forgive their sin.' },
      { ref: 'Galatians 3:6-18', testament: 'NT', title: 'Faith vs. works of the law', connection: 'NT: Paul argues from Gen 15 that a person is not made right with God by the law.' },
      { ref: 'Romans 4:1-25', testament: 'NT', title: 'Abraham justified by faith', connection: 'NT: Paul applies that same Old Testament foundation to Jew and Gentile alike.' },
      { ref: 'Hebrews 8:8-13', testament: 'NT', title: 'New covenant in Christ\'s blood', connection: 'NT: the promise God made in Jeremiah 31 comes true at the table and at the cross.' },
    ],
  },
  {
    id: 'serpent-dragon',
    ...
    steps: [
      ...
      { ref: 'Leviticus 16:8-10', testament: 'OT', title: 'Scapegoat for Azazel', connection: 'Same-OT: the second goat carries the people\'s sin away from the camp into the wilderness.' },
      { ref: 'Job 1-2', testament: 'OT', title: 'The Satan as accuser', connection: 'Same-OT: the adversary stands among the sons of God in the heavenly court.' },
      ...
      { ref: 'Revelation 20:2', testament: 'NT', title: 'Bound a thousand years', connection: 'NT: the crushing of the serpent\'s head promised at the beginning reaches its end in the dragon bound and thrown into the lake of fire.' },
    ],
  },
  {
    ...
    steps: [
      { ref: 'Genesis 4:2; 4:20', verseId: 'gen-4-2', testament: 'OT', title: 'Abel keeper of sheep; Jabal father of herdsmen', connection: 'This is the first shepherd named in the Bible, and he lives in a world broken by sin.' },
      ...
      { ref: 'Ezekiel 34:11-16, 23-24', testament: 'OT', title: 'I myself will be their shepherd; my servant David', connection: 'Same-OT: God promises to shepherd His people Himself, and He will also raise up David.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { ref: 'Exodus 30:10', verseId: 'exo-30-10', testament: 'OT', title: 'Day of Atonement — the sanctuary is cleansed by blood', connection: 'Same-OT: annual purging of accumulated sin from the sanctuary.' },
      { ref: 'Exodus 20:8-11', verseId: 'exo-20-8', testament: 'OT', title: 'Sabbath as creation memorial', connection: 'Same-OT: God\'s covenant people are known by the rest he gave them.' },
      { ref: 'Daniel 7:9-10, 22', verseId: 'dan-7-9', testament: 'OT', title: 'Heavenly court; judgment given to the saints', connection: 'Same-OT: God holds court in heaven and gives the kingdom to his people.' },
      ...
      { ref: 'Daniel 9:24-27', verseId: 'dan-9-24', testament: 'OT', title: 'Seventy weeks — the Messiah, his cutting off, the end of sacrifice', connection: 'Same-OT: messianic mission within a fixed prophetic window.' },
      ...
      { ref: 'Revelation 20:4-6', verseId: 'rev-20-4', testament: 'NT', title: 'First resurrection — the rest of the dead live not again', connection: 'NT: the dead in Christ rest until he returns. Then they rise in the body.' },
    ],
  },
  {
    ...
    steps: [
      { ref: 'Deuteronomy 18:15', verseId: 'deu-18-15', testament: 'OT', title: 'The LORD will raise up a Prophet like me', connection: 'God first promises a prophet from Israel who will speak for Him to the people.' },
      { ref: 'Deuteronomy 18:18-19', verseId: 'deu-18-18', testament: 'OT', title: 'Words put in His mouth', connection: 'Same-OT: the prophet speaks God\'s own commands, and everyone must obey them.' },
      { ref: 'Deuteronomy 34:10', testament: 'OT', title: 'No prophet since like Moses', connection: 'Same-OT: this verse marks the promise as still open. Joshua and the prophets were not the One.' },
      { ref: 'John 1:45', testament: 'NT', title: 'Found Him of whom Moses wrote', connection: 'NT: the first disciples saw Jesus as the Prophet like Moses.' },
      { ref: 'John 5:46', testament: 'NT', title: 'Moses wrote of Me', connection: 'NT: Jesus says the writings of Moses pointed to Him.' },
      { ref: 'Matthew 17:5', testament: 'NT', title: 'Hear Him — Transfiguration', connection: 'NT: at the Transfiguration the Father spoke from a cloud. He repeated the command of Deut 18:15 and told the disciples to hear Jesus.' },
      { ref: 'Acts 3:22-23', testament: 'NT', title: 'Peter cites Deuteronomy 18', connection: 'NT: the apostles preach that God raised up Jesus as the Prophet whom everyone must obey.' },
      { ref: 'Acts 7:37', testament: 'NT', title: 'Stephen before the Sanhedrin', connection: 'NT: Stephen tells the council that Jesus is the Prophet like Moses.' },
      { ref: 'Hebrews 3:1-6', testament: 'NT', title: 'Jesus counted worthy of more glory than Moses', connection: 'NT: Jesus receives greater glory than Moses, because Moses served in the house and Jesus is the Son over it.' },
    ],
  },
  {
    id: 'bronze-serpent',
    ...
    steps: [
      { ref: 'Numbers 21:8-9', verseId: 'num-21-9', testament: 'OT', title: 'Bronze serpent set upon a pole', connection: 'Earliest type: anyone who looked at the sign of judgment was healed.' },
      { ref: '2 Kings 18:4', testament: 'OT', title: 'Nehushtan broken in pieces', connection: 'Same-OT: the sign became an idol. The bronze itself had no power to save anyone.' },
      { ref: 'John 3:14-15', testament: 'NT', title: 'Even so must the Son of Man be lifted up', connection: 'NT: Jesus used the serpent on the pole to point to his own crucifixion, which brings eternal life.' },
      { ref: 'John 8:28', testament: 'NT', title: 'When you lift up the Son of Man', connection: 'NT: being lifted up on the cross shows who he really is.' },
      { ref: 'John 12:32-33', testament: 'NT', title: 'Lifted up from the earth to draw all', connection: 'NT: his crucifixion draws people of every nation to himself.' },
      { ref: '2 Corinthians 5:21', testament: 'NT', title: 'Made sin for us', connection: 'NT: God made Christ to be sin for us. In him we are made right with God.' },
    ],
  },
  {
    ...
    origin: 'Exodus 17:6',
    steps: [
      { ref: 'Exodus 17:6', verseId: 'exo-17-6', testament: 'OT', title: 'Moses smites the rock at Horeb', connection: 'The earliest picture of God\'s provision: he makes water gush from the rock Moses struck in the desert.' },
      ...
      { ref: 'Zechariah 14:8', testament: 'OT', title: 'Living waters go out from Jerusalem', connection: 'Same-OT: water that gives life flows out from Jerusalem.' },
  ...
  },
  {
    ...
    origin: 'Exodus 16:4',
    steps: [
      { ref: 'Exodus 16:4', verseId: 'exo-16-4', testament: 'OT', title: 'Bread rained from heaven', connection: 'The earliest time God fed his people with food he gave from the sky, in the desert.' },
      ...
      { ref: 'Psalm 78:24-25', testament: 'OT', title: 'Bread of heaven — angels\' food', connection: 'Same-OT: the psalm celebrates the food God gave.' },
      ...
      { ref: 'John 6:31-35', testament: 'NT', title: 'I am the Bread of Life', connection: 'NT: Jesus contrasts the manna that perishes with his own living flesh, given for the world.' },
      ...
      { ref: 'Revelation 2:17', testament: 'NT', title: 'Hidden manna to the overcomer', connection: 'NT: the feast at the end of the story is promised to the faithful.' },
    ],
  },
  {
    id: 'righteous-branch',
    ...
    steps: [
      { ref: '2 Samuel 7:12-16', verseId: '2sa-7-12', testament: 'OT', title: 'God\'s binding promise to David: a house and a throne forever', connection: 'This is the earliest promise of a royal family line: God will establish David\'s descendant.' },
      { ref: '2 Samuel 23:5', verseId: '2sa-23-5', testament: 'OT', title: 'God\'s binding promise to make it branch forth forever', connection: 'In the same Old Testament David speaks his last words, and he looks forward to God making his salvation branch forth.' },
      { ref: 'Isaiah 4:2', testament: 'OT', title: 'Branch of the LORD beautiful and glorious', connection: 'In the same Old Testament Isaiah gives the Branch this name on the day God cleanses his people.' },
      { ref: 'Isaiah 11:1-2', verseId: 'isa-11-1', testament: 'OT', title: 'Shoot from the stem of Jesse, Branch from his roots', connection: 'In the same Old Testament God\'s Spirit rests on this ruler, who will rule over the nations.' },
      { ref: 'Jeremiah 23:5-6', verseId: 'jer-23-5', testament: 'OT', title: 'The Righteous Branch, the LORD Our Righteousness', connection: 'In the same Old Testament a king rules with wisdom, and he does what is just and right.' },
      { ref: 'Jeremiah 33:15', testament: 'OT', title: 'The Branch of righteousness growing up for David', connection: 'In the same Old Testament God binds himself to David with a promise, and he will not take it back.' },
      { ref: 'Zechariah 3:8', testament: 'OT', title: 'My Servant the BRANCH', connection: 'In the same Old Testament, after the exile, God confirms the promise of the Branch again.' },
      { ref: 'Zechariah 6:12-13', verseId: 'zec-6-12', testament: 'OT', title: 'Priest-King on His throne', connection: 'In the same Old Testament the Branch builds the LORD\'s temple, and he is both priest and king on his throne.' },
      { ref: 'Luke 1:78', testament: 'NT', title: 'Dayspring from on high (Anatolē / Tsemach)', connection: 'In the New Testament Zechariah praises the sunrise that visits us from on high, and he uses the same word for the Branch.' },
      { ref: 'Romans 15:12', testament: 'NT', title: 'Root of Jesse reigning over Gentiles', connection: 'In the New Testament Paul quotes Isaiah 11:10 to show that the Gentiles also have hope.' },
      { ref: 'Revelation 5:5; 22:16', testament: 'NT', title: 'Root and Offspring of David', connection: 'In the New Testament Jesus is the triumphant Lion and the morning star.' },
    ],
  },
  {
    id: 'kinsman-redeemer',
  ...
  },
  {
    ...
    steps: [
      ...
      { ref: 'Psalm 22:16-18', verseId: 'psa-22-16', testament: 'OT', title: 'They pierced My hands and feet; cast lots for garments', connection: 'Same-OT: a detailed prophecy. His body would be pierced, and soldiers would divide his clothes.' },
      { ref: 'Psalm 69:21', testament: 'OT', title: 'Gall for food, vinegar for thirst', connection: 'Same-OT: the righteous man suffers. They offered him a bitter drink.' },
      { ref: 'Isaiah 50:6', testament: 'OT', title: 'I gave my back to the smiters, my cheeks to those plucking the beard', connection: 'Same-OT: he chose to submit to public shame and violence.' },
      { ref: 'Isaiah 53:4-6', verseId: 'isa-53-5', testament: 'OT', title: 'Wounded for our transgressions, healed by His stripes', connection: 'Same-OT: the Servant bears sin in the place of others. He takes what is theirs.' },
      { ref: 'Zechariah 12:10', verseId: 'zec-12-10', testament: 'OT', title: 'Look on Me whom they have pierced', connection: 'Same-OT: the speaker here is God himself. He is pierced, and people mourn for him as for an only son.' },
      { ref: 'Zechariah 13:7', verseId: 'zec-13-7', testament: 'OT', title: 'Awake, O sword, against My Shepherd', connection: 'Same-OT: the Shepherd is close to the LORD. The sword strikes the Shepherd down.' },
      ...
      { ref: '1 Peter 2:21-25', testament: 'NT', title: 'His own self bare our sins on the tree', connection: 'Peter applies Isaiah 53 to what Christ did in our place.' },
      { ref: 'Revelation 1:7', testament: 'NT', title: 'Every eye shall see Him, and they who pierced Him', connection: 'The pierced King appears at the end of the story.' },
    ],
  },
  {
    ...
    steps: [
      { ref: 'Deuteronomy 30:6', verseId: 'deu-30-6', testament: 'OT', title: 'The LORD will circumcise your heart', connection: 'The earliest promise that God will work inside a person, in place of outward failure.' },
      { ref: 'Jeremiah 31:31-34', verseId: 'jer-31-31', testament: 'OT', title: 'The New Covenant — law written on the heart', connection: 'Same-OT: God plainly promises a new covenant, his binding promise. He forgives their sins for good.' },
      { ref: 'Ezekiel 36:26-27', verseId: 'ezk-36-26', testament: 'OT', title: 'A new heart and the Spirit within', connection: 'Same-OT: God takes away the heart of stone and gives a heart of flesh.' },
      { ref: 'Luke 22:20', testament: 'NT', title: 'This cup is the New Covenant in My blood', connection: 'NT: at the Last Supper Jesus begins the new covenant, God\'s binding promise.' },
      { ref: '1 Corinthians 11:25', testament: 'NT', title: 'The New Covenant remembered at the Lord\'s Supper', connection: 'NT: the church of the apostles keeps remembering the new covenant, God\'s binding promise.' },
      { ref: '2 Corinthians 3:3-6', testament: 'NT', title: 'Ministers of the New Covenant in the Spirit', connection: 'NT: God writes on hearts of flesh, not on stone.' },
      { ref: 'Romans 2:29', testament: 'NT', title: 'Circumcision is of the heart, in the spirit', connection: 'NT: the Spirit, not an outward sign, defines who you are inside. This fulfills Deut 30:6.' },
      { ref: 'Hebrews 8:6-13', testament: 'NT', title: 'Christ stands between God and us in a better covenant, God\'s binding promise.', connection: 'NT: the New Testament writers quote the promise from Jeremiah 31 in full. Then they explain what those words mean.' },
      { ref: 'Hebrews 10:15-18', testament: 'NT', title: 'Their sins and iniquities I will remember no more', connection: 'NT: Christ\'s sacrifice is final. It completes the new covenant, God\'s binding promise.' },
    ],
  },
  {
    ...
    origin: 'Job 19:25',
    steps: [
      { ref: 'Job 19:25-27', verseId: 'job-19-25', testament: 'OT', title: 'In my flesh I shall see God', connection: 'This is the earliest clear hope that a person will see God in the body after the body has fallen apart.' },
      { ref: 'Psalm 16:9-11', verseId: 'psa-110-1', testament: 'OT', title: 'Thou wilt not leave my soul in Sheol', connection: 'Same-OT: David prophesied that the grave would not keep him.' },
      { ref: 'Isaiah 26:19', testament: 'OT', title: 'Awake and sing, ye that dwell in dust', connection: 'Same-OT: the earth gives up its dead in the resurrection.' },
      { ref: 'Ezekiel 37:1-14', verseId: 'ezk-37-12', testament: 'OT', title: 'I will open your graves — dry bones live', connection: 'Same-OT: a vision of the Spirit raising the dead out of their graves.' },
      { ref: 'Daniel 12:2-3', verseId: 'dan-12-2', testament: 'OT', title: 'They that sleep in dust awake', connection: 'Same-OT: the resurrection runs two ways, to everlasting life or to shame.' },
      { ref: 'Hosea 13:14', testament: 'OT', title: 'O death, I will be thy plagues', connection: 'Same-OT: YHWH pays the price to bring his people back from the power of the grave.' },
      ...
      { ref: 'John 11:25-26', testament: 'NT', title: 'I am the Resurrection and the Life', connection: 'Jesus shows his authority to raise the dead when he raises Lazarus.' },
      { ref: 'Acts 2:27-31; 13:35-37', testament: 'NT', title: 'Apostles preach Christ risen without corruption', connection: 'Psalm 16 was fulfilled in Christ\'s empty tomb.' },
      { ref: '1 Corinthians 15:20-23, 51-55', testament: 'NT', title: 'Christ the firstfruits; death swallowed up', connection: 'Paul quotes Isaiah 25:8 and Hosea 13:14 to prove the bodily resurrection.' },
      { ref: '1 Thessalonians 4:13-18', testament: 'NT', title: 'The dead in Christ shall rise first', connection: 'At the Lord\'s descent, believers are raised in the body, and everyone sees it.' },
      { ref: 'Revelation 20:4-6, 12-14', testament: 'NT', title: 'First resurrection; death cast into the lake of fire', connection: 'Death is finally conquered, and the body is vindicated.' },
    ],
  },
  {
    id: 'day-of-the-lord',
    ...
    origin: 'Joel 2:28',
    steps: [
      { ref: 'Joel 2:28-29', verseId: 'jol-2-28', testament: 'OT', title: 'I will pour out My Spirit on all flesh', connection: 'Earliest promise that God would pour out His Spirit on all people in the last days.' },
      { ref: 'Joel 2:30-32', verseId: 'jol-2-32', testament: 'OT', title: 'Signs in heaven; whosoever calls on the LORD is saved', connection: 'Same-OT: signs in the sky come before the great and terrible day of the LORD.' },
      { ref: 'Amos 5:18-20', testament: 'OT', title: 'The day of the LORD is darkness, not light', connection: 'Same-OT: God judges the empty worship of people who kept only the outward show.' },
      { ref: 'Zephaniah 1:14-18', testament: 'OT', title: 'The great day of the LORD is near and hastens', connection: 'Same-OT: the day comes on everyone, and no one can escape it.' },
      { ref: 'Malachi 4:1-5', testament: 'OT', title: 'Sun of Righteousness arises with healing in His wings', connection: 'Same-OT: an oven for the proud, and healing dawn for the faithful.' },
      { ref: 'Acts 2:16-21', testament: 'NT', title: 'Peter at Pentecost: "This is that spoken by Joel"', connection: 'NT: Peter says the Spirit poured out that day is what Joel foretold.' },
      { ref: 'Romans 10:13', testament: 'NT', title: 'Whosoever shall call upon the name of the Lord shall be saved', connection: 'NT: Paul takes Joel 2:32 and applies it to calling on Jesus.' },
      { ref: 'Matthew 24:29-31', testament: 'NT', title: 'Cosmic signs before Christ the Son of Man arrives', connection: 'NT: Jesus uses Joel\'s darkened sun and moon for His second coming.' },
      { ref: '1 Thessalonians 5:1-4', testament: 'NT', title: 'The Day of the Lord as a thief in the night', connection: 'NT: the day comes without warning on the world, but believers wait and watch.' },
      { ref: '2 Peter 3:10-13', testament: 'NT', title: 'New heavens and new earth in which righteousness dwells', connection: 'NT: the elements melt with fervent heat. God makes a new creation that lasts.' },
      { ref: 'Revelation 6:16-17; 19:11-21', testament: 'NT', title: 'The great day of His wrath has come', connection: 'NT: the kings cry to the mountains. The King of kings wins the victory.' },
    ],
  },
  {
    ...
    origin: 'Isaiah 40:3',
    steps: [
      { ref: 'Isaiah 40:3', verseId: 'isa-40-3', testament: 'OT', title: 'Voice crying in the wilderness', connection: 'The voice in Isaiah 40 cries out to clear a road for the LORD.' },
      ...
      { ref: 'Malachi 4:5-6', verseId: 'mal-4-5', testament: 'OT', title: 'Elijah sent before the great and dreadful day', connection: 'Same-OT: the message turns people\'s hearts back to God before judgment falls.' },
      { ref: 'Luke 1:17', testament: 'NT', title: 'In the spirit and power of Elijah', connection: 'NT: the angel Gabriel tells Zacharias that his son will do what Malachi 4:6 promised.' },
      { ref: 'Matthew 11:10, 14', testament: 'NT', title: 'If you will receive it, this is Elijah', connection: 'NT: Jesus says plainly that John is the Elijah promised before the first coming.' },
      { ref: 'Matthew 17:10-13', testament: 'NT', title: 'Elijah truly shall come and restore all things', connection: 'NT: John came as the forerunner, and that same work of restoration will come before the second coming.' },
      { ref: 'John 1:23', testament: 'NT', title: 'Voice crying in the wilderness', connection: 'NT: John quotes Isaiah 40:3 for his mission.' },
      { ref: 'Revelation 14:6-12', testament: 'NT', title: 'Three Angels\' Messages: Final Elijah proclamation', connection: 'NT: the three angels\' message calls the world back to worship the Creator. That call goes out before judgment falls.' },
    ],
  },
  {
    ...
    steps: [
      { ref: 'Deuteronomy 11:14', verseId: 'deu-11-14', testament: 'OT', title: 'First rain and latter rain promised', connection: 'God\'s binding promise starts here. He gives rain at the right time for sowing and for harvest.' },
      { ref: 'Hosea 6:3', verseId: 'hos-6-3', testament: 'OT', title: 'He shall come as the rain to the earth', connection: 'Same-OT: God promises to come to his people and give them new life, shown as rain.' },
      { ref: 'Joel 2:23', verseId: 'jol-2-23', testament: 'OT', title: 'Former rain and latter rain in the first month', connection: 'Same-OT: rain falling on the ground shows the Holy Spirit poured out.' },
      { ref: 'Joel 2:28-29', verseId: 'jol-2-28', testament: 'OT', title: 'Pour out My Spirit on all flesh', connection: 'Same-OT: God promises his Holy Spirit to young and old, to servants and to handmaids.' },
      { ref: 'Zechariah 10:1', verseId: 'zec-10-1', testament: 'OT', title: 'Ask rain in the time of the latter rain', connection: 'Same-OT: God tells his people to pray for the last rain, the one that ripens the crop.' },
      { ref: 'Acts 2:1-4, 16-21', testament: 'NT', title: 'Pentecost: The Early Rain of the Spirit', connection: 'NT: Peter says the prophecy of Joel 2 came true that day. The early rain gave the church power.' },
      { ref: 'James 5:7', verseId: 'jam-5-7', testament: 'NT', title: 'Be patient until the early and latter rain', connection: 'NT: James takes this farming picture to call for patient waiting until the Lord comes.' },
      { ref: 'Revelation 18:1', testament: 'NT', title: 'Earth lightened with His glory (Loud Cry)', connection: 'NT: the Holy Spirit is poured out for the last time. His light covers the earth before the harvest.' },
    ],
  },
  // ── Historic Adventist Master Pillar Chains ──────────────────────────────
  {
    ...
    steps: [
      ...
      { ref: 'Leviticus 16:16-19', verseId: 'lev-16-16', testament: 'OT', title: 'Yom Kippur, the Day of Atonement — God cleanses the sanctuary every year by blood', connection: 'Same-OT: each year the Day of Atonement cleansed the holy places. It removed the sin that had piled up.' },
      { ref: 'Daniel 7:9-10, 22', verseId: 'dan-7-9', testament: 'OT', title: 'Heavenly court seated and books opened', connection: 'Same-OT: the court sits in heaven before Christ returns, and the Ancient of Days gives the verdict for his saints.' },
      { ref: 'Daniel 8:14', verseId: 'dan-8-14', testament: 'OT', title: 'Unto 2,300 days. Then shall the sanctuary be cleansed', connection: 'Anchor prophecy: 2,300 prophetic day-years point to the day God makes the heavenly sanctuary right (nitsdaq).' },
      ...
      { ref: 'Hebrews 9:23-24', verseId: 'heb-9-23', testament: 'NT', title: 'The heavenly patterns purified with better sacrifices', connection: 'NT: the earthly sanctuary was purified with animal blood. Christ entered heaven itself by his own blood.' },
      { ref: 'Revelation 11:19', verseId: 'rev-11-19', testament: 'NT', title: 'The temple of God opened in heaven; the ark of His testament seen', connection: 'NT: Most Holy Place opened at the sounding of the seventh trumpet.' },
      { ref: 'Revelation 14:7', verseId: 'rev-14-7', testament: 'NT', title: 'The hour of His judgment is come — worship the Creator', connection: 'NT: judgment begins in heaven before Christ returns. It brings the final cleansing.' },
    ],
  },
  {
    ...
    steps: [
      { ref: 'Ezra 7:11-26', verseId: 'ezr-7-11', testament: 'OT', title: 'Decree of Artaxerxes to restore Jerusalem (457 BC)', connection: 'Historical datum: in his seventh year Artaxerxes I gave the Jews full authority to rebuild their city; this starts the 70-week and 2,300-day counts.' },
      { ref: 'Daniel 9:24', verseId: 'dan-9-24', testament: 'OT', title: 'Seventy weeks determined upon thy people', connection: 'Prophetic timeline: God sets apart 70 sevens — 490 years — for his covenant people, and the promised King makes the atonement for sin in that time.' },
      ...
      { ref: 'Luke 3:1, 21-23', verseId: 'luk-3-1', testament: 'NT', title: '27 AD: Jesus baptized and anointed with the Holy Spirit', connection: 'NT fulfillment: in the fifteenth year of Tiberius Caesar, Jesus is anointed the Messiah, that is, the Christ, at his baptism.' },
      { ref: 'Daniel 9:26', verseId: 'dan-9-26', testament: 'OT', title: 'Messiah cut off, but not for Himself', connection: 'Same-OT: the Anointed One is cut off in a violent death, and not for himself.' },
      ...
      { ref: 'Matthew 27:51', verseId: 'mat-27-51', testament: 'NT', title: '31 AD: Temple veil rent in twain at crucifixion', connection: 'NT fulfillment: Christ dies at Passover, the earlier picture meets the person it pointed to, and the animal sacrifices come to an end.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { ref: 'Exodus 20:8-11', verseId: 'exo-20-8', testament: 'OT', title: 'Fourth Commandment: Perpetual memorial of Creation', connection: 'God wrote the Sabbath into the Ten Commandments, at the heart of the moral law.' },
      { ref: 'Ezekiel 20:12, 20', verseId: 'ezk-20-12', testament: 'OT', title: 'Perpetual sign of sanctification between God and His people', connection: 'The Sabbath marks out the God who created all things and who makes His people holy.' },
      { ref: 'Luke 4:16', verseId: 'luk-4-16', testament: 'NT', title: 'Christ\'s custom: synagogue worship on the Sabbath day', connection: 'Jesus kept the Sabbath on earth throughout His life.' },
      { ref: 'Matthew 24:20', verseId: 'mat-24-20', testament: 'NT', title: 'Pray that your flight be not on the Sabbath', connection: 'Jesus told His disciples to pray that their flight would not fall on the Sabbath. That command reaches past the Cross.' },
      { ref: 'Hebrews 4:4, 9', verseId: 'heb-4-9', testament: 'NT', title: 'There remaineth therefore a Sabbath-keeping (sabbatismos)', connection: 'The weekly rest still stands, and it shows God\'s people the rest they have in Him.' },
      { ref: 'Revelation 14:7', verseId: 'rev-14-7', testament: 'NT', title: 'Final call: Worship Him that made heaven, earth, and sea', connection: 'The Third Angel repeats Exodus 20:11, so the call to worship the Creator comes before judgment.' },
      { ref: 'Isaiah 66:22-23', verseId: 'isa-66-22', testament: 'OT', title: 'New Earth: From one Sabbath to another all flesh worships', connection: 'In the restored creation, Sabbath worship goes on without end.' },
    ],
  },
  {
    ...
    origin: 'Genesis 2:7',
    steps: [
      { ref: 'Genesis 2:7', verseId: 'gen-2-7', testament: 'OT', title: 'Dust + breath of life = living soul (nephesh chayah)', connection: 'Man does not have a soul that lives on by itself. God formed man from dust and breathed life into him, and man became a living soul.' },
      { ref: 'Genesis 3:19', verseId: 'gen-3-19', testament: 'OT', title: 'Dust thou art, and unto dust shalt thou return', connection: 'The body returns to dust and the breath returns to God.' },
      { ref: 'Psalm 146:4', verseId: 'psa-146-4', testament: 'OT', title: 'Breath goeth forth; in that very day his thoughts perish', connection: 'The dead are not conscious at all. Thinking and awareness stop for good at death.' },
      { ref: 'Ecclesiastes 9:5-6, 10', verseId: 'ecc-9-5', testament: 'OT', title: 'The dead know not anything; no device in the grave', connection: 'In death there is no awareness, no praise, and no way to speak with anyone.' },
      { ref: '1 Timothy 6:16', verseId: '1ti-6-16', testament: 'NT', title: 'God alone possesses immortality', connection: 'Immortality belongs to God alone. Human beings receive it only as a gift.' },
      { ref: 'John 11:11-14', verseId: 'joh-11-11', testament: 'NT', title: 'Jesus defines death as an unconscious sleep', connection: 'Jesus first described death as sleep. Then He said plainly, "Our friend Lazarus sleepeth... Lazarus is dead."' },
      { ref: '1 Thessalonians 4:13-17', verseId: '1th-4-13', testament: 'NT', title: 'The dead in Christ shall rise first at the Lord\'s descent', connection: 'At the second coming, which people hear and see, Jesus wakes every believer from sleep.' },
      { ref: '1 Corinthians 15:51-54', verseId: '1co-15-51', testament: 'NT', title: 'Mortal puts on immortality at the last trump', connection: 'God makes the body incorruptible at the resurrection. At death the body is still corruptible.' },
      { ref: 'Malachi 4:1-3', verseId: 'mal-4-1', testament: 'OT', title: 'Wicked burned to stubble; become ashes under feet', connection: 'God destroys the wicked completely in the lake of fire. He does not torture them forever.' },
      { ref: 'Revelation 20:14', verseId: 'rev-20-14', testament: 'NT', title: 'Death and hell cast into the lake of fire — the second death', connection: 'God destroys sin, death, and the grave forever, and the whole universe is clean.' },
    ],
  },
  {
    ...
    steps: [
      { ref: 'Exodus 20:11', verseId: 'exo-20-11', testament: 'OT', title: 'Creator\'s Seal in the Fourth Commandment', connection: 'The fourth commandment carries the Creator\'s own seal: his name, YHWH, his office as Maker, and his territory of heaven, earth, and sea.' },
      { ref: 'Daniel 7:25', verseId: 'dan-7-25', testament: 'OT', title: 'Little horn thinks to change times and laws (1260 days)', connection: 'Prophetic warning: an apostate power tries to change God\'s Sabbath and his law while it holds supremacy.' },
      { ref: 'Revelation 7:2-3', verseId: 'rev-7-2', testament: 'NT', title: 'Seal of the living God placed upon the servants\' foreheads', connection: 'End-time protection: God seals his servants on their foreheads before the winds blow, so they are settled in the truth beforehand.' },
      { ref: 'Revelation 12:17', verseId: 'rev-12-17', testament: 'NT', title: 'Remnant keeps commandments of God and testimony of Jesus', connection: 'Loyalty marker: the faithful few who are left withstand the dragon\'s final wrath through obedience and faith.' },
      { ref: 'Revelation 14:6-7', verseId: 'rev-14-6', testament: 'NT', title: 'First Angel: Everlasting gospel, judgment hour, Creator-worship', connection: 'Proclamation: the angel announces the true gospel and calls the world back to worship the Creator and keep the fourth commandment, before judgment begins.' },
      ...
      { ref: 'Revelation 14:12', verseId: 'rev-14-12', testament: 'NT', title: 'Patience of the saints: commandments of God and faith of Jesus', connection: 'Remnant character: the faithful few who are left keep God\'s commandments, and they endure because they trust the faith of Jesus.' },
  ...
  },
  {
    ...
    steps: [
      { ref: 'Isaiah 14:12-15', verseId: 'isa-14-12', testament: 'OT', title: 'Lucifer\'s pride and desire for self-exaltation', connection: 'Lucifer wanted to be like God. He said, "I will ascend above the stars... I will be like the most High."' },
      ...
      { ref: 'Genesis 3:15', verseId: 'gen-3-15', testament: 'OT', title: 'The first gospel promise: the woman\'s Seed will crush the serpent.', connection: 'Cosmic battle on earth: Seed of woman conquers through sacrifice.' },
      ...
      { ref: 'Colossians 2:15', verseId: 'col-2-15', testament: 'NT', title: 'Christ spoils principalities and powers on the Cross', connection: 'The cross answered and disarmed the accusations Satan made against the character of God.' },
  ...
  },
  {
    ...
    origin: 'Amos 3:7',
    steps: [
      { ref: 'Amos 3:7', verseId: 'amo-3-7', testament: 'OT', title: 'God reveals His secret to His servants the prophets', connection: 'Divine rule: God always tells His prophets what He is about to do before He does it.' },
      { ref: 'Numbers 12:6', verseId: 'num-12-6', testament: 'OT', title: 'Prophetic criteria: visions and dreams', connection: 'God speaks to His true prophets this way, and the Spirit guides them.' },
      ...
      { ref: '1 Corinthians 12:28', verseId: '1co-12-28', testament: 'NT', title: 'Prophets placed permanently in the body of Christ', connection: 'Apostolic order: Paul says God placed prophets in the church. The gifts He gave keep working until the church is one in faith and fully grown.' },
      ...
      { ref: 'Revelation 19:10', verseId: 'rev-19-10', testament: 'NT', title: 'The testimony of Jesus is the Spirit of Prophecy', connection: 'John\'s definition: Jesus Himself is the one the Holy Spirit speaks about through prophecy.' },
      { ref: 'Revelation 22:9', verseId: 'rev-22-9', testament: 'NT', title: 'Fellowservant of thy brethren the prophets', connection: 'A parallel in Scripture: the angel puts "the testimony of Jesus" alongside "thy brethren the prophets."' },
    ],
  },
  {
  ...
  },
  {
    ...
    origin: 'Isaiah 8:20',
    steps: [
      { ref: 'Isaiah 8:20', verseId: 'isa-8-20', testament: 'OT', title: 'Test 1: To the Law and to the Testimony', connection: 'Moral and prophetic consistency: every doctrine must agree with God\'s law and with what the prophets said. A teaching that contradicts either one has no light in it.' },
      { ref: '2 Peter 1:20-21', testament: 'NT', title: 'Test 2: Sola Scriptura / Analogia Scripturae', connection: 'Canonical harmony: the whole Bible must agree. No prophecy "is of private interpretation"; the rest of Scripture settles what it means.' },
      { ref: 'Hebrews 8:1-2', verseId: 'heb-8-1', testament: 'NT', title: 'Test 3: Christ-Centered Sanctuary Baseline', connection: 'Every prophetic time-period points to Jesus. It centers on His sacrifice, His priesthood, and His return.' },
    ],
  },
];
