...
export const threadChains: ThreadChain[] = [
  ...
  },
  {
    ...
    steps: [
      { ref: 'Deuteronomy 18:15', verseId: 'deu-18-15', testament: 'OT', title: 'The LORD will raise up a Prophet like me', connection: 'The earliest promise of a final prophet from among Israel, one who stands between God and the people.' },
      { ref: 'Deuteronomy 18:18-19', verseId: 'deu-18-18', testament: 'OT', title: 'Words put in His mouth', connection: 'Same-OT: this prophet speaks God\'s own commands, with authority that must be obeyed.' },
      { ref: 'Deuteronomy 34:10', testament: 'OT', title: 'No prophet since like Moses', connection: 'Same-OT: this verse is a marker in the Bible. It shows Joshua and the prophets were not the promised One.' },
      { ref: 'John 1:45', testament: 'NT', title: 'Found Him of whom Moses wrote', connection: 'NT: the disciples recognize Jesus as the Prophet like Moses.' },
      ...
      { ref: 'Acts 3:22-23', testament: 'NT', title: 'Peter cites Deuteronomy 18', connection: 'NT: the apostles preach that Jesus is the Prophet everyone must obey.' },
      ...
      { ref: 'Hebrews 3:1-6', testament: 'NT', title: 'Jesus counted worthy of more glory than Moses', connection: 'NT: Moses was faithful as a servant. Christ is the Son over the house.' },
    ],
  },
  {
    id: 'bronze-serpent',
  ...
  },
  {
    ...
    steps: [
      ...
      { ref: 'Psalm 22:16-18', verseId: 'psa-22-16', testament: 'OT', title: 'They pierced My hands and feet; cast lots for garments', connection: 'Same-OT: a specific prophecy that his body would be pierced and his clothes divided.' },
      { ref: 'Psalm 69:21', testament: 'OT', title: 'Gall for food, vinegar for thirst', connection: 'Same-OT: the righteous one suffers and is offered a bitter drink.' },
      ...
      { ref: 'Isaiah 53:4-6', verseId: 'isa-53-5', testament: 'OT', title: 'Wounded for our transgressions, healed by His stripes', connection: 'Same-OT: the Servant bears sin in the place of others.' },
      ...
      { ref: 'Zechariah 13:7', verseId: 'zec-13-7', testament: 'OT', title: 'Awake, O sword, against My Shepherd', connection: 'Same-OT: the Shepherd, who is YHWH\'s close Companion, is struck down.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { ref: 'Jeremiah 31:31-34', verseId: 'jer-31-31', testament: 'OT', title: 'The New Covenant — law written on the heart', connection: 'Same-OT: God plainly promises a new covenant — God\'s binding promise — with sins forgiven for good.' },
      ...
      { ref: 'Hebrews 8:6-13', testament: 'NT', title: 'Christ stands between God and us in a better covenant, God\'s binding promise.', connection: 'NT: this passage quotes Jeremiah 31 in full. Then it explains what the words mean.' },
  ...
  },
  {
    ...
    steps: [
      { ref: 'Deuteronomy 11:14', verseId: 'deu-11-14', testament: 'OT', title: 'First rain and latter rain promised', connection: 'God\'s binding promise starts here with rain at the right time for sowing and for harvesting the grain.' },
      { ref: 'Hosea 6:3', verseId: 'hos-6-3', testament: 'OT', title: 'He shall come as the rain to the earth', connection: 'Same-OT: God promises his presence and new life, pictured as rain.' },
      { ref: 'Joel 2:23', verseId: 'jol-2-23', testament: 'OT', title: 'Former rain and latter rain in the first month', connection: 'Same-OT: rain falling on the ground is a picture of the Spirit poured out.' },
      ...
      { ref: 'Zechariah 10:1', verseId: 'zec-10-1', testament: 'OT', title: 'Ask rain in the time of the latter rain', connection: 'Same-OT: God commands his people to pray for the last rain that ripens the crop.' },
      { ref: 'Acts 2:1-4, 16-21', testament: 'NT', title: 'Pentecost: The Early Rain of the Spirit', connection: 'NT: Peter cites Joel 2. The early rain makes the crop sprout. It gives the early church power.' },
      { ref: 'James 5:7', verseId: 'jam-5-7', testament: 'NT', title: 'Be patient until the early and latter rain', connection: 'NT: James uses this picture from farming to call for patient waiting until the Lord comes.' },
  ...
  },
  {
    ...
    origin: 'Genesis 2:7',
    steps: [
      { ref: 'Genesis 2:7', verseId: 'gen-2-7', testament: 'OT', title: 'Dust + breath of life = living soul (nephesh chayah)', connection: 'The creation formula: man does not have a soul that lives on by itself. Man became a living soul.' },
      { ref: 'Genesis 3:19', verseId: 'gen-3-19', testament: 'OT', title: 'Dust thou art, and unto dust shalt thou return', connection: 'The fall: at death the body goes back to dust and the breath goes back to God.' },
      { ref: 'Psalm 146:4', verseId: 'psa-146-4', testament: 'OT', title: 'Breath goeth forth; in that very day his thoughts perish', connection: 'The dead are not conscious at all. Thinking and awareness stop completely at death.' },
      { ref: 'Ecclesiastes 9:5-6, 10', verseId: 'ecc-9-5', testament: 'OT', title: 'The dead know not anything; no device in the grave', connection: 'Scripture agrees: in death there is no awareness, no praise, and no communication.' },
      { ref: '1 Timothy 6:16', verseId: '1ti-6-16', testament: 'NT', title: 'God alone possesses immortality', connection: 'The starting point: immortality belongs to God alone. For human beings it is conditional.' },
      { ref: 'John 11:11-14', verseId: 'joh-11-11', testament: 'NT', title: 'Jesus defines death as an unconscious sleep', connection: 'Christ\'s teaching: "Our friend Lazarus sleepeth... Lazarus is dead."' },
      { ref: '1 Thessalonians 4:13-17', verseId: '1th-4-13', testament: 'NT', title: 'The dead in Christ shall rise first at the Lord\'s descent', connection: 'The apostolic hope: at the second coming, which is heard and seen, believers are woken from sleep, all together.' },
      { ref: '1 Corinthians 15:51-54', verseId: '1co-15-51', testament: 'NT', title: 'Mortal puts on immortality at the last trump', connection: 'The change: the body is made incorruptible at the resurrection, not at death.' },
      { ref: 'Malachi 4:1-3', verseId: 'mal-4-1', testament: 'OT', title: 'Wicked burned to stubble; become ashes under feet', connection: 'God destroys the wicked completely in the final fire. They are not tortured forever.' },
      { ref: 'Revelation 20:14', verseId: 'rev-20-14', testament: 'NT', title: 'Death and hell cast into the lake of fire — the second death', connection: 'God cleans up the whole universe: sin, death, and the grave are destroyed forever.' },
    ],
  },
  {
