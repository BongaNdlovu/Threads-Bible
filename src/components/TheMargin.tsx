            ...
            {messianic.length === 0 ? (
              ...
              <div className="space-y-4">
                {messianic.map(m => {
                  ...
                  return (
                    <div key={m.id} className="p-3.5 rounded-xl border border-foreground/10 bg-background space-y-2.5 shadow-sm">
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] uppercase tracking-wider font-bold px-2 py-0.5 rounded-full bg-accent/15 text-accent">
                          {m.category}
                        </span>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {m.fulfillmentRefs.map((ref, idx) => (
                            <button
                              ...
                              className="px-2 py-0.5 rounded bg-accent/10 text-accent font-mono text-[11px] hover:bg-accent hover:text-accent-foreground transition-colors cursor-pointer"
                            >
                              {ref}
                            </button>
                          ))}
