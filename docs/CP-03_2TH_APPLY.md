# CP-03 · 2 Thessalonians — apply record
...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/2th_rewrites.json --worklist docs/_work/2th_p1.json --apply`
...
=== apply 2 Thessalonians · docs/_work/2th_rewrites.json ===
