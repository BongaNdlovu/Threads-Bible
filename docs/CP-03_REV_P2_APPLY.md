...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/rev_p2_rewrites.json --worklist docs/_work/rev_p2.json --apply`
...
=== apply Revelation · docs/_work/rev_p2_rewrites.json ===
...
--- post-flight (git diff) ---
  verse entries named by drafts:  54
  verse entries git reports:      54
  chain drafts:                   0
