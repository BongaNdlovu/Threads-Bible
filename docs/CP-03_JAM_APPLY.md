...
- in-scope strings: 22
- rewritten: 12 · VERIFY-ONLY: 10 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/jam_rewrites.json --worklist docs/_work/jam_p1.json --apply`
...
=== apply James · docs/_work/jam_rewrites.json ===
drafts: 12 · verify-only: 10 · equivalent: 0
...
Drafts 12 across the book; measured on the entry strings only, chain prose excluded per §1.12.
