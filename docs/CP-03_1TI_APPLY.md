...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/1ti_rewrites.json --worklist docs/_work/1ti_p1.json --apply`
...
=== apply 1 Timothy · docs/_work/1ti_rewrites.json ===
