...
- in-scope strings: 22
- rewritten: 10 · VERIFY-ONLY: 12 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/1jn_rewrites.json --worklist docs/_work/1jn_p1.json --apply`
...
=== apply 1 John · docs/_work/1jn_rewrites.json ===
