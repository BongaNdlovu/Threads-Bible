...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/zep_rewrites.json --worklist docs/_work/zep.json --apply`
...
=== apply Zephaniah · docs/_work/zep_rewrites.json ===
drafts: 8 · verify-only: 8 · equivalent: 0
