...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/hab_rewrites.json --worklist docs/_work/hab.json --apply`
...
=== apply Habakkuk · docs/_work/hab_rewrites.json ===
drafts: 7 · verify-only: 7 · equivalent: 0
...
--- post-flight (git diff) ---
  verse entries named by drafts:  46
  verse entries git reports:      46
  chain drafts:                   0
