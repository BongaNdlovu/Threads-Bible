# CP-03 · 1 Corinthians — apply record
...
- in-scope strings: 90
- rewritten: 44 · VERIFY-ONLY: 46 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/1co_rewrites.json --worklist docs/_work/1co_p1.json --apply`
...
=== apply 1 Corinthians · docs/_work/1co_rewrites.json ===
drafts: 44 · verify-only: 46 · equivalent: 0
worklist strings: 90 · mode: DRY RUN
...
--- post-flight (git diff) ---
  verse entries named by drafts:  34
  verse entries git reports:      34
  chain drafts:                   0
...
Drafts 44 across the book; measured on the entry strings only, chain prose excluded per §1.12.
...
| prerogative | 1 | 0 | 0 |
| redemption | 1 | 1 | 0 |
| sanctification | 3 | 2 | 0 |
| sanctuary | 1 | 1 | 0 |
| typology | 2 | 0 | 0 |

**Punctuation-only audit.** Truly punctuation-only drafts: 0. Capitalisation-only: 1. CAPITALISATION-ONLY (needs a look): 1co-15-55|principle
