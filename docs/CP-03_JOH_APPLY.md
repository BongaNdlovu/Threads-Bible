...
- in-scope strings: 70
- rewritten: 14 · VERIFY-ONLY: 56 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/joh_rewrites.json --worklist docs/_work/joh_p1.json --apply`
...
=== apply John · docs/_work/joh_rewrites.json ===
drafts: 14 · verify-only: 56 · equivalent: 0
worklist strings: 70 · mode: DRY RUN
...
Drafts 14 across the book; measured on the entry strings only, chain prose excluded per §1.12.
