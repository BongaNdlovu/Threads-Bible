...
- in-scope strings: 32
- rewritten: 15 · VERIFY-ONLY: 17 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/1pe_rewrites.json --worklist docs/_work/1pe_p1.json --apply`
...
=== apply 1 Peter · docs/_work/1pe_rewrites.json ===
drafts: 15 · verify-only: 17 · equivalent: 0
...
Drafts 15 across the book; measured on the entry strings only, chain prose excluded per §1.12.
