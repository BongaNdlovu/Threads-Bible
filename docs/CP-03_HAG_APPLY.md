...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/hag_rewrites.json --worklist docs/_work/hag.json --apply`
...
=== apply Haggai · docs/_work/hag_rewrites.json ===
...
--- post-flight (git diff) ---
  verse entries named by drafts:  59
  verse entries git reports:      59
  chain drafts:                   0
