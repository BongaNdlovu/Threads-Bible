...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/2ti_rewrites.json --worklist docs/_work/2ti_p1.json --apply`
...
=== apply 2 Timothy · docs/_work/2ti_rewrites.json ===
