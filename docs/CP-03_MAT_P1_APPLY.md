...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/mat_p1_rewrites.json --worklist docs/_work/mat_p1.json --apply`
...
=== apply Matthew · docs/_work/mat_p1_rewrites.json ===
...
**QUOTE-REVIEW (5)** — where the existing text's quotation does not match the KJV. Under invariant I1 each is left byte-identical and recorded rather than "restored":
...
**THEOLOGY-REVIEW (1)** — wording the operator should confirm:
