...
- in-scope strings: 20
- rewritten: 10 · VERIFY-ONLY: 10 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/mic_rewrites.json --worklist docs/_work/mic.json --apply`
...
=== apply Micah · docs/_work/mic_rewrites.json ===
drafts: 10 · verify-only: 10 · equivalent: 0
...
--- post-flight (git diff) ---
  verse entries named by drafts:  35
  verse entries git reports:      35
  chain drafts:                   0
