...
- in-scope strings: 82
- rewritten: 42 · VERIFY-ONLY: 40 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/isa_p3_rewrites.json --worklist docs/_work/isa_p3.json --apply`
