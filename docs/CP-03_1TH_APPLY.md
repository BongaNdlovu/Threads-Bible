# CP-03 · 1 Thessalonians — apply record
...
- in-scope strings: 28
- rewritten: 14 · VERIFY-ONLY: 14 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/1th_rewrites.json --worklist docs/_work/1th_p1.json --apply`
...
=== apply 1 Thessalonians · docs/_work/1th_rewrites.json ===
drafts: 14 · verify-only: 14 · equivalent: 0
worklist strings: 28 · mode: DRY RUN
