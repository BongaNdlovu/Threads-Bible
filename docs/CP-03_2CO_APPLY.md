# CP-03 · 2 Corinthians — apply record
...
- in-scope strings: 34
- rewritten: 17 · VERIFY-ONLY: 17 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/2co_rewrites.json --worklist docs/_work/2co_p1.json --apply`
...
=== apply 2 Corinthians · docs/_work/2co_rewrites.json ===
drafts: 17 · verify-only: 17 · equivalent: 0
worklist strings: 34 · mode: DRY RUN
...
--- post-flight (git diff) ---
  verse entries named by drafts:  15
  verse entries git reports:      15
  chain drafts:                   0
...
Drafts 17 across the book; measured on the entry strings only, chain prose excluded per §1.12.
