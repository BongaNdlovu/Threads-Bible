...
- in-scope strings: 12
- rewritten: 6 · VERIFY-ONLY: 6 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/phm_rewrites.json --worklist docs/_work/phm_p1.json --apply`
...
=== apply Philemon · docs/_work/phm_rewrites.json ===
drafts: 6 · verify-only: 6 · equivalent: 0
...
--- post-flight (git diff) ---
  verse entries named by drafts:  6
  verse entries git reports:      6
  chain drafts:                   0
