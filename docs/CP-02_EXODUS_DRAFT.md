...
Total Exodus entries: 39

## exo-12-13 — Blood on the Doorposts
...
### terms[0].note (pass over)

**BEFORE**

```
Root of Pesach / Passover; sparing judgment.
```
...
## exo-12-21 — Draw Out and Take You a Lamb
...
## exo-12-27 — It Is the Sacrifice of the LORD'S Passover
...
```
Greek ἀμνός / ἀρνίον — John and Revelation.
```
...
### terms[1].gloss (without blemish)

**BEFORE**

```
complete, sound, without defect
```
...
### terms[1].note (without blemish)

**BEFORE**

```
1 Pet 1:19 — lamb without blemish and spot.
```
...
```
John 19:36 — Scripture fulfilled.
```
...
### terms[1].gloss (shall not be broken)

**BEFORE**

```
shall be shattered / crushed
```
...
### terms[1].note (shall not be broken)

**BEFORE**

```
John 19:36 passive: the Father withholds the fracture.
```
...
### terms[1].exposition (shall not be broken)
...
## exo-12-6 — The Whole Assembly Shall Kill It in the Evening
...
## exo-14-21 — The Waters Were Divided
...
## exo-14-22 — The Waters Were a Wall unto Them
...
## exo-15-25 — The LORD Shewed Him a Tree
...
## exo-16-14 — A Small Round Thing, as Small as the Hoar Frost
...
## exo-16-35 — They Did Eat Manna Forty Years
...
```
They Did Eat Manna Forty Years
```
...
```
Greek ἄρτος — John 6 manna discourse.
```
...
## exo-17-12 — Aaron and Hur Stayed Up His Hands
...
```
Greek πέτρα (petra) in 1 Cor 10:4 — typological Christ.
```
...
## exo-19-5 — Ye Shall Be a Peculiar Treasure unto Me
...
### terms[0].gloss (kingdom of priests)
...
### terms[0].note (kingdom of priests)

**BEFORE**

```
LXX βασίλειον ἱεράτευμα — 1 Pet 2:9.
```
...
## exo-20-11 — Seventh Day — Pattern from Creation
...
```
Seventh Day — Pattern from Creation
```
...
### terms[0].note (seventh day)

**BEFORE**

```
Ordinal is explicit — not "a" day but "the" seventh. Heb 4:4 preserves this creation logic.
```
...
## exo-20-8 — Remember the Sabbath Day — Grounded in Creation and Fulfilled in Christ
...
```
Remember the Sabbath Day — Grounded in Creation and Fulfilled in Christ
```
...
### terms[0].gloss (Sabbath)

**BEFORE**

```
rest, sabbath (from shavat — cease)
```
...
### terms[0].note (Sabbath)

**BEFORE**

```
Greek σάββατον in NT; same seventh-day institution from creation (Gen 2:2-3; Exod 20:11) through the covenant sign (Exod 31:16-17) and prophets (Isa 58:13-14) to Hebrews 4.
```
...
### terms[1].gloss (keep it holy)

**BEFORE**

```
to sanctify / set it apart
```
...
### terms[1].note (keep it holy)

**BEFORE**

```
Same qadash root as God sanctifying the seventh day in Gen 2:3.
```
...
### terms[2].gloss (perpetual covenant)
...
### terms[2].note (perpetual covenant)

**BEFORE**

```
Exod 31:16-17 seals the Sabbath as a perpetual covenant memorial of Creation.
```
...
### terms[3].note (Sabbath-rest)

**BEFORE**

```
Heb 4:9 — there remains therefore a rest (sabbatismos) to the people of God.
```
...
## exo-25-40 — Pattern of the Tabernacle
...
### terms[0].note (pattern)

**BEFORE**

```
Heb 8:5 — ὑπόδειγμα / σκιά — copy and shadow.
```
...
## exo-28-36 — HOLINESS TO THE LORD Engraved on Gold
...
```
HOLINESS TO THE LORD Engraved on Gold
```
...
## exo-3-13 — What Is His Name? What Shall I Say?
...
### terms[0].gloss (I AM WHO I AM)

**BEFORE**

```
I will be what I will be / I am who I am
```
...
### terms[0].note (I AM WHO I AM)

**BEFORE**

```
LXX ἐγώ εἰμι ὁ ὤν — John 8:58 claims this name.
```
...
## exo-3-15 — This Is My Name for Ever, My Memorial to All Generations
...
```
This Is My Name for Ever, My Memorial to All Generations
```
...
## exo-3-2 — The Bush Burned with Fire, and Was Not Consumed
...
### terms[0].gloss (atonement)

**BEFORE**

```
to cover, purge, make atonement
```
...
### terms[0].note (atonement)

**BEFORE**

```
Greek καταλλάσσω / ἱλασμός in NT for reconciliation/propitiation.
```
...
## exo-30-30 — Anoint Aaron and His Sons for the Priest's Office
...
```
Anoint Aaron and His Sons for the Priest's Office
```
...
## exo-33-18 — I Beseech Thee, Shew Me Thy Glory
...
## exo-33-19 — I Will Proclaim the Name of the LORD Before Thee
...
## exo-34-28 — Forty Days and Forty Nights Without Bread
...
```
Forty Days and Forty Nights Without Bread
```
...
## exo-34-34 — He Took the Vail Off Until He Came Out
...
## exo-34-6 — The LORD God, Merciful and Gracious
...
## exo-4-22 — Israel Is My Son, Even My Firstborn
...
## exo-40-34 — The Glory of the LORD Filled the Tabernacle
