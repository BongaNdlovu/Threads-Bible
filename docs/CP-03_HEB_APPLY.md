...
- in-scope strings: 104
- rewritten: 43 · VERIFY-ONLY: 61 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/heb_rewrites.json --worklist docs/_work/heb_p1.json --apply`
...
=== apply Hebrews · docs/_work/heb_rewrites.json ===
drafts: 43 · verify-only: 61 · equivalent: 0
worklist strings: 104 · mode: DRY RUN
...
--- post-flight (git diff) ---
  verse entries named by drafts:  41
  verse entries git reports:      41
  chain drafts:                   0
...
Drafts 43 across the book; measured on the entry strings only, chain prose excluded per §1.12.
