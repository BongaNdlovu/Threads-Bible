...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/oba_rewrites.json --worklist docs/_work/oba.json --apply`
...
=== apply Obadiah · docs/_work/oba_rewrites.json ===
...
--- post-flight (git diff) ---
  verse entries named by drafts:  21
  verse entries git reports:      21
  chain drafts:                   0
