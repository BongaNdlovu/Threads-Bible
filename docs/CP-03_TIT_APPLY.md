...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/tit_rewrites.json --worklist docs/_work/tit_p1.json --apply`
...
=== apply Titus · docs/_work/tit_rewrites.json ===
drafts: 9 · verify-only: 9 · equivalent: 0
worklist strings: 18 · mode: DRY RUN
