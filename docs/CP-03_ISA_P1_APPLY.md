...
- rewritten: 55 · VERIFY-ONLY: 49 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/isa_p1_rewrites.json --worklist docs/_work/isa_p1.json --apply`
