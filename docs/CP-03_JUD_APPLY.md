...
- in-scope strings: 16
- rewritten: 7 · VERIFY-ONLY: 9 · EQUIVALENT: 0
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/jud_rewrites.json --worklist docs/_work/jud_p1.json --apply`
...
=== apply Jude · docs/_work/jud_rewrites.json ===
drafts: 7 · verify-only: 9 · equivalent: 0
worklist strings: 16 · mode: DRY RUN
...
Drafts 7 across the book; measured on the entry strings only, chain prose excluded per §1.12.
