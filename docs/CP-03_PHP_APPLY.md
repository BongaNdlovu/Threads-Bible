# CP-03 · Philippians — apply record
...
- applier: `npx tsx scripts/cp03ApplyRewrites.ts docs/_work/php_rewrites.json --worklist docs/_work/php_p1.json --apply`
...
=== apply Philippians · docs/_work/php_rewrites.json ===
